    ...
    <div className="min-h-screen bg-paper text-ink flex flex-col relative z-0">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 bg-transparent py-6 px-4 sm:px-8 md:px-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 font-sans font-semibold text-sm">
          <a href="#" className="text-white hover:text-ochre-light font-bold transition-colors">
            Beranda
          </a>
          <a href="#best-sellers" className="text-white/80 hover:text-ochre-light transition-colors">
            Produk Terlaris
          </a>
          <a href="#kisah-desa" className="text-white/80 hover:text-ochre-light transition-colors">
            Kisah Pengrajin
          </a>
          <a href="#faq" className="text-white/80 hover:text-ochre-light transition-colors">
            FAQ
          </a>
        </div>
        <div>
      ...
      <section id="kisah-desa" className="py-16 px-4 max-w-6xl mx-auto w-full scroll-mt-20">
      ...
      <section id="faq" className="py-16 px-4 max-w-6xl mx-auto w-full scroll-mt-20">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-sans text-paper-light/60">
              ...
              <li><a href="#best-sellers" className="hover:text-white">Produk Terlaris</a></li>
              <li><a href="#kisah-desa" className="hover:text-white">Kisah Pengrajin</a></li>
            </ul>
          </div>
          <div>
