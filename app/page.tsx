...
export default function Home() {
  return (
    <div className="min-h-screen bg-paper text-ink flex flex-col">
      ...
      <nav className="sticky top-0 bg-paper/85 backdrop-blur-md z-50 border-b border-ink/5 py-4 px-8 md:px-16 flex items-center justify-between">
      ...
      {/* Hero Section */}
      <header className="relative py-24 px-8 md:px-16 max-w-6xl mx-auto text-center flex flex-col items-center justify-center overflow-hidden">
        ...
        <h1 className="font-display text-5xl md:text-6xl font-black tracking-tight max-w-4xl leading-tight">
          Menghubungkan Karya Terbaik Desa Langsung ke Tangan Anda
        </h1>
        <p className="font-sans text-lg md:text-xl text-ink/80 max-w-2xl mt-6 leading-relaxed">
      ...
      <section id="peta-rute" className="py-16 px-8 md:px-16 max-w-6xl mx-auto w-full scroll-mt-20">
        ...
        {/* The Desktop Map Container */}
        <div className="relative w-full h-[480px] bg-paper-light/40 border border-ink/10 rounded-2xl hidden lg:block overflow-hidden p-6 shadow-sm">
          ...
          {/* Kios Node 1 Card (Left Upper) */}
          <div className="absolute left-[5%] top-[40px] w-[290px]">
          ...
          {/* Kios Node 2 Card (Center Bottom) */}
          <div className="absolute left-[35.5%] top-[200px] w-[290px]">
            <Card variant="organic" className="shadow-md hover:shadow-lg bg-paper-light border-ochre/30">
              <CardHeader className="pb-2">
                <div className="flex justify-between items-center mb-1">
          ...
          {/* Kios Node 3 Card (Right Upper) */}
          <div className="absolute left-[66%] top-[40px] w-[290px]">
            <Card variant="organic" className="shadow-md hover:shadow-lg bg-paper-light border-ochre/30">
              <CardHeader className="pb-2">
                <div className="flex justify-between items-center mb-1">
        ...
        {/* Fallback Text for Mobile Viewport in Step 2 */}
        <div className="lg:hidden text-center bg-paper-light/50 border border-ink/10 p-6 rounded-xl">
          <p className="font-sans text-sm text-ink/70">
            Geser halaman ke bawah untuk mengunjungi kios-kios kami satu per satu secara berurutan.
          </p>
        </div>
      </section>

      {/* Main Kiosk Content List */}
      <section id="daftar-kios" className="py-16 px-8 md:px-16 max-w-6xl mx-auto w-full scroll-mt-20 flex-1">
        <div className="flex items-center justify-between border-b border-ink/10 pb-4 mb-16">
          <h2 className="font-display text-3xl font-extrabold tracking-tight">Daftar Kios Pasar Desa</h2>
        ...
        <div className="space-y-24">
          {umkmList.map((umkm, idx) => (
            <div key={umkm.id} id={umkm.id} className="scroll-mt-24">
              ...
              <div className="bg-paper-light/30 border border-ink/10 rounded-xl p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <Badge variant="dark">Kios 0{idx + 1}</Badge>
                    <span className="font-mono text-xs text-ink/50">ID: {umkm.id}</span>
                  </div>
                  <h3 className="font-display text-3xl font-black text-ink">{umkm.nama}</h3>
                  <p className="font-sans text-base text-ink/80 italic mt-1 leading-relaxed">
                    &ldquo;{umkm.tagline}&rdquo;
                  </p>
                </div>
                <div className="flex flex-col items-start md:items-end justify-center font-mono text-xs text-ink/70 gap-1.5 border-t md:border-t-0 md:border-l border-ink/10 pt-4 md:pt-0 md:pl-6 shrink-0">
      ...
      <footer className="bg-ink text-paper-light py-12 px-8 md:px-16 border-t border-ink/20 mt-20">
        ...
        <div className="max-w-6xl mx-auto border-t border-paper-light/10 mt-8 pt-6 flex flex-col md:flex-row items-center justify-between text-xs text-paper-light/40 gap-4">
          ...
          <span className="font-mono">BUILD V1.0.0-DESKTOP</span>
        </div>
      </footer>
    </div>
  );
